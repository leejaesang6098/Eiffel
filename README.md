...
---
## 회고
주커버그가 이런 새해 목표를 발표 한것에 대해서 모르고 있었는데 알게 되어서 좋았고 여러 빅테크 기업들이 인공지능 개발 경쟁이 재밌게 흘러가는거 같고 열심히 노력해서 나도 인공지능 개발 경쟁에 참여하고 싶다. 또 인공지능이 최근 10년간 많은 발전을 이룬것이 되게 놀랍고 인공지능에 대한 흥미가 한번더 오르게 되는 계기가 되었고 인공지능이 최근 20년간 급격하게 발전한것은 딥러닝의 개발이 큰역할을 했다는 얘기를 들었는데 딥러닝에 대해서 추가적인 공부를 해보고 싶다는 생각이 든다.
...
AI기술은 이런 작은 호기심에서도 발전이 되기때문에 나 스스로도 멈추지 말고 계속 공부해 나가며 숙달시켜야 시대에 뒤쳐지지 않게 살아갈 수 있겠구나 라는 점을 느끼며 계속 공부해나가다 보면 나도 언젠간 저렇게 스스로 AI기술을 일상생활에 접목시킬 수
있으리라 믿는다.
...
---
## 회고
내용을 보다 보니 위험한 용도로 사용이 된다는 내용이 있었는데 실제 고등학교때 친구들과 모의해킹을 준비할때 gpt에게 공격코드를 작성해달라고 하니 실제로 작성을 해줬던 경험이 있는데 
이처럼 공격적인 목적으로 gpt를 이용한다면 gpt가 인간을 뛰어넘는 초인공지능적 존재가 된다면 사회에 큰 혼란이 일어날수 있다는 생각이 들고 인공지능의 발전에 맞춰서 그에 맞는 인공지능 윤리의식도
발전 해야 하며 인공지능이 스스로 문제가 있을 만한 요청을 거절하는 능력을 가져야 한다고 생각한다.
김민지/쏘카
